...
public class SystemConfig {
     ...
     */
    public static long MODIFY_TOKEN_TIME = 60 * 60 * 1000;

    /**
     * web Token 过期时间(毫秒单位
     */
    public static long OVERDUE_TOKEN_TIME = 2 * 60 * 60 * 1000;

    /**
     * app Token 过期时间(毫秒单位
     */
    public static long OVERDUE_TOKEN_TIME_APP = 365 * 24 * 60 * 60 * 1000;

    /**
     * web Token redis中TOKEN删除时间(毫秒单位
     */
    public static long REDIS_DELETE_TOKEN_TIME = 365 * 60 * 60 * 1000;
}
