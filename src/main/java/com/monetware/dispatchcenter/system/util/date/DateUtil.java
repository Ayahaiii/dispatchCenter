package com.monetware.dispatchcenter.system.util.date;


import com.monetware.dispatchcenter.system.enums.DateStyle;
...
public class DateUtil {
     ...
     * @Description: 日期往前
     */
    public static Date dateBack(Date date, Integer days) {
     ...
     * @Description: 时间推前
     */
    public static Date dateBack(Integer param){
    ...
    //将当前时间加一天
    public static Date dateToLargeTime(Date endTime){

        long newLongEndTime = endTime.getTime() +  longTime;
